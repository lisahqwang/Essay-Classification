...
class TrigramModel(object):
    ...
    def count_ngrams(self, corpus):
        ...
        # keep end, remove STARTs
        self.numberOfWords = values - self.unigramcounts[('START',)] 
        return
    ...
    def perplexity(self, corpus):
        ...
        for sentence in corpus: 
            #END token is included in total number of words but not start
...
if __name__ == "__main__":
    ...
    #print(get_ngrams(["natural","language","processing"], 7))

    #generator = corpus_reader(r"C:\Users\wangs\OneDrive\Desktop\Homework\hw1_data\hw1_data\brown_test.txt")
    #for sentence in generator:
    #    print(sentence)

    #model = TrigramModel(r"C:\Users\wangs\OneDrive\Desktop\Homework\hw1_data\hw1_data\brown_train.txt")
